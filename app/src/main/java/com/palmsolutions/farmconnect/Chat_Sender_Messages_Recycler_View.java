...
public class Chat_Sender_Messages_Recycler_View extends RecyclerView.Adapter<Chat_Sender_Messages_Recycler_View.ViewHolder> {
    ...
    public Chat_Sender_Messages_Recycler_View(Context context, ChatModel chatModel){
    ...
    @NonNull
    @Override
    public Chat_Sender_Messages_Recycler_View.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.message_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Chat_Sender_Messages_Recycler_View.ViewHolder holder, int position) {
